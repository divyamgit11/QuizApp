...
const url = "mongodb+srv://divyam1071be21:owBcOHmXA7cmXu4B@cluster0.iekwmxo.mongodb.net/?retryWrites=true&w=majority";
let databaseName;
let CollectionName;
mongodb.connect(url).then((result => {
  databaseName = result.db('QuizApp');
  CollectionName = databaseName.collection('Users');
